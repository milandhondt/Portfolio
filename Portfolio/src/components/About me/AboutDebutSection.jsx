    ...
    <>
      <section className="bg-[#333333] flex flex-col items-center justify-center text-center px-6">
        ...
        <p className="text-xl text-white mt-3 max-w-xl">
          Ik ben een 22-jarige Full Stack Developer. Tijdens mijn opleiding heb ik een sterke interesse ontwikkeld in zowel frontend als backend development. Ik werk graag in teamverband, omdat ik de verschillende input van mensen enorm leuk en interessant vind.
        </p>
      </section>
